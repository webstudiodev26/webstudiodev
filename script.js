...
const translations = {
  ...
  en: {
    navLabel: 'Main navigation', languageLabel: 'Choose language', themeLabel: 'Switch to dark theme', navHome: 'Home', navWork: 'Work', navAbout: 'About us', contact: 'Contact', headlineFirst: 'Websites that bring', headlineSecond: 'results', heroCopy: 'We design and develop websites, from the first sketch to launch and long-term support.', startProject: 'Start a project', servicesLabel: 'Services', domain: 'Domain', webDesign: 'Web design', webDevelopment: 'Web development', uiDesign: 'UI/UX design', promoPosts: 'Promo posts', domainRegistration: 'Domain registration', belowEyebrow: 'FROM IDEA TO SCREEN', belowTitle: 'Work', viewSite: 'View site ↗'
  }
};
